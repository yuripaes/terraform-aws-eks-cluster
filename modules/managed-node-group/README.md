...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | EKS cluster name to create managed group | `string` | n/a | yes |
| <a name="input_private-subnet-1a"></a> [private-subnet-1a](#input\_private-subnet-1a) | Subnet ID from AZ 1a | `string` | n/a | yes |
| <a name="input_private-subnet-1b"></a> [private-subnet-1b](#input\_private-subnet-1b) | Subnet ID from AZ 1a | `string` | n/a | yes |
